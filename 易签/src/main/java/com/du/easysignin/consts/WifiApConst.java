...
public class WifiApConst {
    ...
    // WifiAP 参数
    public static final String WIFI_AP_HEADER = "易签_";
    public static final String WIFI_AP_PASSWORD = "yiqian_";
    public static final String WIFI_AP_MNAME = "longlong";
    public static final String WIFI_AP_MPASSWORD = "123456789";

    //添加班级信息
    public static final int ADDCLASS_NAME=10;
}