...
import com.du.easysignin.utils.WifiUtils.WifiCipherType;
...
public class ConnWifiDialog extends BaseDialog {
    ...
    private void initEvents() {
        ...
        setButton1(mContext.getString(R.string.btn_yes), new DialogInterface.OnClickListener() {
        ...
        setButton2(mContext.getString(R.string.btn_cancel), new DialogInterface.OnClickListener() {
